...
class Item(db.Model):
    ...
    image_url = db.Column(db.String(500), nullable=True) # Primary image (backwards compatibility)
    images = db.Column(db.Text, nullable=True) # JSON list of all images
    category_id = db.Column(db.Integer, nullable=True)
    event_date = db.Column(db.DateTime, nullable=True)
    location_detail = db.Column(db.String(200), nullable=True)
